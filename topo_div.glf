...
pw::Connector setCalculateDimensionMaximum 10000
 
if {$airfoil==1} {
	puts "2-D CRM-HL wing section"
} elseif {$airfoil==2} {
	puts "2-D 30P-30N airfoil configuration"
} else {
...
$a_dom setExtrusionSolverAttribute StopAtHeight 0.003
...
#slat BL extrusion
set s_edge [pw::Edge createFromConnectors [list $su $sl $ste]]
...
$s_dom setExtrusionSolverAttribute StopAtHeight 0.003
...
#flap extrusion
set f_edge [pw::Edge createFromConnectors [list [lindex $con_flapsp 0] [lindex $con_flapsp 1] $fl $fte]]
...
$f_dom setExtrusionSolverAttribute StopAtHeight 0.003
...
set sconsp [$scon split -I [list $tpts1_sg [expr $tpts1_sg+[$sl getDimension]-1]]]
set ste [lindex $sconsp 0]
set sl [lindex $sconsp 1]
set su [lindex $sconsp 2]

set fcon [[$f_dom getEdge 3] getConnector 1]
set fconsp [$fcon split -I [list [expr [$fcon getDimension]-$tpts2_sg+1] [expr [$fcon getDimension]-[$fl getDimension]-$tpts2_sg+2]]]
set fu [lindex $fconsp 0]
set fl [lindex $fconsp 1]
...
set ptAs [[$su getNode Begin] getXYZ]
...
set ptAfu1 [[$fu getNode Begin] getXYZ]
...
set ptAfu2 [[$fl getNode End] getXYZ]
...
set con_flapsp [$fu split -I [list [expr [$fu getDimension] - [$wc getDimension] + 1]]]
...
$reg1_seg1 setSlopeOut 1 {0.00028003821120529265 0.026843848647783129 0}
$reg1_seg1 setSlopeIn 2 {0.027322318410456431 -0.023058205096515447 0}
set reg1_con1 [pw::Connector create]
$reg1_con1 addSegment $reg1_seg1

set reg1_seg3 [pw::SegmentSpline create]
$reg1_seg3 addPoint $ptAs
$reg1_seg3 addPoint [[[lindex $con_consp 2] getNode Begin] getXYZ]
$reg1_seg3 setSlope Free
$reg1_seg3 setSlopeOut 1 {0.017052455992903677 -0.018606420877533933 0}
$reg1_seg3 setSlopeIn 2 {0.047308220353033517 0.08002196653944238 0}
...
$reg3_seg1 addPoint [[[lindex $con_flapsp 0] getNode Begin] getXYZ]
...
$reg3_seg3 addPoint [[[lindex $con_flapsp 1] getNode End] getXYZ]
$reg3_seg3 addPoint [[$wc getNode End] getXYZ]
$reg3_seg3 setSlope Free
$reg3_seg3 setSlopeOut 1 {-0.0047313471397705253 -0.00042093952933004199 0}
$reg3_seg3 setSlopeIn 2 {0.037991509529443634 -0.0077176155052986663 0}
